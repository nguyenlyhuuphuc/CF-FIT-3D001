...
{
    private $vnpaySerivce;

    public function __construct(VNPaySerivce $vnpaySerivce)
    {
    ...
    public function placeOrder(Request $request){
        try{
            ...
            if($paymentMethod === 'VNBANK'){
                $vnp_Url = $this->vnpaySerivce->getVNPayUrl($order, 'VNBANK');
                return Redirect::to($vnp_Url);
            }elseif($paymentMethod === 'INTCARD'){
                $vnp_Url = $this->vnpaySerivce->getVNPayUrl($order, 'INTCARD');
                return Redirect::to($vnp_Url);
            }
